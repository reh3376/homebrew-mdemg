...
1. Download from [ollama.com/download/mac](https://ollama.com/download/mac) or:
   ...
   brew install ollama
   ```
2. Pull a compatible embedding model (~4.9 GB):
   ```bash
